<?php
    ...
    if ( $_SERVER["REQUEST_METHOD"] == "POST" and isset( $_REQUEST ) ) {
        ...
        if ( $result === FALSE ) {
            ...
            if ( $response["success"] ) {
                ...
                $subject = "New Business Card Request - $firstName $lastName";
        
                // Build the email content.
                $email_content = "<html><body>";
                $email_content .= "<p>Hello,</p>";
                $email_content .= "<p><b>$firstName $lastName</b> has submitted a request for new business cards. The details for the business card are as followed:</p>";
                ...
                $email_content .= "<p>If you have any questions or concerns regarding the business card details, please contact <b>$firstName $lastName</b> directly at $email.</p>";
                $email_content .= "<p><i>P.S.: This email is generated by Creative Media Services on behalf of $firstName $lastName's request for a new business card. Replying to this email will send the message directly to $email.</i></p>";
                $email_content .= "<p>Thank you,<br><br>Creative Media Services</p>";
